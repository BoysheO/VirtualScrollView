/*=================================================
*FileName:      VirtualScrollViewEditor.cs 
*Author:        tanhaojin 
*UnityVersion:  2019.4.15f1 
*Date:          2022-04-14 17:49 
*Description:   
*History:       
=================================================*/
/*
...
[CustomEditor(typeof(VirtualScrollView), true)]
[CanEditMultipleObjects]
public class VirtualScrollViewEditor : Editor
{
    ...
    {
        SetAnimBool(m_ShowElasticity, !m_MovementType.hasMultipleDifferentValues && m_MovementType.enumValueIndex == (int)VirtualScrollView.MovementType.Elastic, instant);
    ...
    void CalculateCachedValues()
    {
        ...
        if (targets.Length == 1)
        {
            Transform transform = ((VirtualScrollView)target).transform;
    ...
    public override void OnInspectorGUI()
    {
        ...
        ((VirtualScrollView)target).normalizedPosition = EditorGUILayout.Vector2Field(nameof(VirtualScrollView.normalizedPosition),
            ((VirtualScrollView)target).normalizedPosition);
        ...
        if (m_ScrollbarSetting)
        {
            ...
            if (m_HorizontalScrollbar.objectReferenceValue && !m_HorizontalScrollbar.hasMultipleDifferentValues)
            {
                ...
                if ((VirtualScrollView.ScrollbarVisibility) m_HorizontalScrollbarVisibility.enumValueIndex ==
                    VirtualScrollView.ScrollbarVisibility.AutoHideAndExpandViewport
            ...
            if (m_VerticalScrollbar.objectReferenceValue && !m_VerticalScrollbar.hasMultipleDifferentValues)
            {
                ...
                if ((VirtualScrollView.ScrollbarVisibility) m_VerticalScrollbarVisibility.enumValueIndex ==
                    VirtualScrollView.ScrollbarVisibility.AutoHideAndExpandViewport
